#-------------------------------------------------
#
# Project created by QtCreator 2015-09-14T16:20:26
#
#-------------------------------------------------

QT       -= gui

TARGET = PP_LoadFromFusion
TEMPLATE = lib

DEFINES += PP_LOADFROMFUSION_LIBRARY

SOURCES += pp_loadfromfusion.cpp

HEADERS += pp_loadfromfusion.h\
        pp_loadfromfusion_global.h \
    region_growing.h \
    region_growing.hpp
...
-lpcl_filters_release -lpcl_segmentation_release
...
win32:CONFIG(release, debug|release): LIBS += -lpcl_io_release
