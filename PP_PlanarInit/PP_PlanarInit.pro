#-------------------------------------------------
#
# Project created by QtCreator 2015-08-10T16:40:04
#
#-------------------------------------------------

QT       -= gui

TARGET = PP_PlanarInit
TEMPLATE = lib

DEFINES += PP_PLANARINIT_LIBRARY

SOURCES += pp_planarinit.cpp

HEADERS += pp_planarinit.h\
        pp_planarinit_global.h
