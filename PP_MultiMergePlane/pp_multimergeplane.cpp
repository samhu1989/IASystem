...
{
    return new PP_MultiMergePlane();
}

PP_MultiMergePlane::PP_MultiMergePlane()
{
}

int PP_MultiMergePlane::configure(Config& config)
{
...
int PP_MultiMergePlane::init(void)
{
...
int PP_MultiMergePlane::work(void)
{
    loadCam();
    loadFrame();
    segFrameRegionGrow();
...
int PP_MultiMergePlane::saveToData(void)
{
    inform("Saving Data");
...
void PP_MultiMergePlane::loadFrame(void)
{
...
void PP_MultiMergePlane::loadFrame(unsigned int frameIdx)
{
...
void PP_MultiMergePlane::loadCam(void)
{
    unsigned int cam_idx;
    cv::Mat ex;
...
void PP_MultiMergePlane::segPlane(FullPointCloud::Ptr& pcd)
{
...
void PP_MultiMergePlane::segFloor(FullPointCloud::Ptr& pcd)
{
    FullPointCloud::Ptr cloud_p (new FullPointCloud);
    FullPointCloud::Ptr cloud_f (new FullPointCloud);
    pcl::ModelCoefficients::Ptr coefficients (new pcl::ModelCoefficients ());
...
void PP_MultiMergePlane::segWall(FullPointCloud::Ptr& pcd)
{
    FullPointCloud::Ptr cloud_p (new FullPointCloud);
    FullPointCloud::Ptr cloud_f (new FullPointCloud);
    pcl::ModelCoefficients::Ptr coefficients (new pcl::ModelCoefficients ());
...
void PP_MultiMergePlane::segFrameRegionGrow(void)
{
    pcl::search::Search<FullPoint>::Ptr tree = boost::shared_ptr<pcl::search::Search<FullPoint> > (new pcl::search::KdTree<FullPoint>);
    pcl::NormalEstimationOMP<FullPoint,FullPoint> est;
    est.setSearchMethod (tree);
...
void PP_MultiMergePlane::loadCam(const std::string& path, Eigen::Matrix4f& _CamEx)
{
    QFile file;
...
void PP_MultiMergePlane::addToDepthMap(const FullPointCloud::Ptr& pcd,unsigned int frameIdx)
{
...
void PP_MultiMergePlane::segWalls(FullPointCloud::Ptr& ptr)
{
    inform("segWall");
...
bool PP_MultiMergePlane::isWithinWall(FullPoint& p)
{
    Eigen::Vector2f v;
    v(0) = p.x;
    v(1) = p.y;
